\hypertarget{group__icub__aexGrabber}{\section{aex\-Grabber}
\label{group__icub__aexGrabber}\index{aex\-Grabber@{aex\-Grabber}}
}
This is a module that extracts independent event-\/driven response to changes in the luminance sensed

Event driven asynchronous sensors transmit the local pixel-\/level changes caused by movement in a scene at the time they occur. The result is a stream of events at microsecond time resolution with very low redundancy that drastically reduces power, data storage and computational requirements.\hypertarget{group__processing_reference}{}\subsection{reference}\label{group__processing_reference}
...
S. R. Deiss, T. Delbrück, R. J. Douglas, M. Fischer, M. Mahowald, T. Matthews, and A. M. Whatley, Address-\/event asynchronous local broadcast protocol, Inst. Neuroinform., Zurich, Switzerland, 1994 \mbox{[}Online\mbox{]}. Available\-: \href{http://www.ini.uzh.ch/~amw/scx/aeprotocol.html}{\tt http\-://www.\-ini.\-uzh.\-ch/$\sim$amw/scx/aeprotocol.\-html}
...
V. Dante, P. Del Giudice, and A. M. Whatley, “\-P\-C\-I-\/\-A\-E\-R—hardware and software for interfacing to address-\/event based neuromorphic systems,” The Neuromorphic Engineer vol. 2, no. 1, pp. 5–6, 2005 \mbox{[}Online\mbox{]}. Available\-: \href{http://ine-web.org/research/newsletters/index.html}{\tt http\-://ine-\/web.\-org/research/newsletters/index.\-html}\hypertarget{group__icub__aexGrabber_Description}{}\subsection{Description}\label{group__icub__aexGrabber_Description}
\hypertarget{group__icub__aexGrabber_lib_sec}{}\subsection{Libraries}\label{group__icub__aexGrabber_lib_sec}
Y\-A\-R\-P.\hypertarget{group__processing_parameters_sec}{}\subsection{Parameters}\label{group__processing_parameters_sec}
...
The following key-\/value pairs can be specified as parameters in the configuration file (they can also be specified as command-\/line parameters if you so wish). The value part can be changed to suit your needs; the default values are shown below.\hypertarget{group__processing_portsa_sec}{}\subsection{Ports Accessed}\label{group__processing_portsa_sec}

\begin{DoxyItemize}
\item None
\end{DoxyItemize}\hypertarget{group__processing_portsc_sec}{}\subsection{Ports Created}\label{group__processing_portsc_sec}
...
\item {\ttfamily /aex\-Grabber/image}\-:o \par
 {\bfseries Port types}
\end{DoxyItemize}\hypertarget{group__icub__aexGrabber_in_files_sec}{}\subsection{Input Data Files}\label{group__icub__aexGrabber_in_files_sec}
None\hypertarget{group__icub__aexGrabber_out_data_sec}{}\subsection{Output Data Files}\label{group__icub__aexGrabber_out_data_sec}
None\hypertarget{group__icub__aexGrabber_conf_file_sec}{}\subsection{Configuration Files}\label{group__icub__aexGrabber_conf_file_sec}
{\ttfamily aex\-Grabber.\-ini} in {\ttfamily \$\-I\-C\-U\-B\-\_\-\-R\-O\-O\-T/app/aex\-Grabber/conf} \par
 \hypertarget{group__icub__aexGrabber_tested_os_sec}{}\subsection{Tested O\-S}\label{group__icub__aexGrabber_tested_os_sec}
Windows, Linux\hypertarget{group__processing_example_sec}{}\subsection{Example Instantiation of the Module}\label{group__processing_example_sec}
